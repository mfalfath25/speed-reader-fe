...
export const Home = () => {
  ...
  return (
    <>
      ...
      <p className="mb-4 flex items-center justify-center pt-2 text-xl sm:mb-10 sm:text-2xl">
        Selamat datang, {userData.username}
      </p>

      <div className="grid grid-cols-1 space-y-2 sm:space-y-20">
        <div className="card-body w-full rounded-lg bg-base-300 p-4 outline outline-2 lg:p-8">
          <h1 className="card-title mx-auto mb-2 text-lg md:text-2xl">
          ...
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-6">
            {homeMenu.map((menu, index) => (
              <div key={index} className="m-0 w-full">
                <div className="card-body rounded-lg bg-base-300 p-4 outline outline-2 xl:p-8">
                  <h1 className="card-title mx-auto mb-2 text-lg md:text-2xl">
                    {menu.description}
                  </h1>
